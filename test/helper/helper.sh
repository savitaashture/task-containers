...
declare -rx E2E_PARAMS_TLS_VERIFY="${E2E_PARAMS_TLS_VERIFY:-}"

# prepares for the bats test case creating a new temporary directoy, shared by the BASE_DIR variable.
function setup() {
...
# deletes the temporary directory created for the test case (BASE_DIR).
function teardown() {
